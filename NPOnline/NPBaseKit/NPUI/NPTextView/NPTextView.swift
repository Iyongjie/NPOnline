...
@objc public protocol NPTextViewDelegate: class {
    func npTextViewDidChange(_ textView: UITextView)
    func npTextViewDidEndEditing(_ textView: UITextView)
    func npTextViewDidBeginEditing(_ textView: UITextView)
    func npTextViewCharactersCount(_ count: Int)
}

extension NPTextViewDelegate {
    func npTextViewDidChange(_ textView: UITextView) {}
    func npTextViewDidEndEditing(_ textView: UITextView) {}
    func npTextViewDidBeginEditing(_ textView: UITextView) {}
    func npTextViewCharactersCount(_ count: Int) {}
...
@IBDesignable public class NPTextView: UIView {
    ...
    @IBOutlet public weak var delegate: NPTextViewDelegate?
...
extension NPTextView: UITextViewDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        ...
        self.delegate?.npTextViewCharactersCount((textView.text ?? "").count)
        self.delegate?.npTextViewDidChange(textView)
    }
    ...
    public func textViewDidEndEditing(_ textView: UITextView) {
        ...
        self.delegate?.npTextViewDidEndEditing(textView)
    }
    ...
    public func textViewDidBeginEditing(_ textView: UITextView) {
        ...
        self.delegate?.npTextViewDidBeginEditing(textView)
    }
